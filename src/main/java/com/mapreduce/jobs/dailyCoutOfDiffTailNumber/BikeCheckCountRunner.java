...
public class BikeCheckCountRunner {
        public static void run(String[] inputs, String output){
        JobConf jobConf = new JobConf(BikeCheckCountRunner.class);
        ...
        jobConf.setMapperClass(BikeCheckCountMapper.class);
        jobConf.setReducerClass(BikeCheckCountReducer.class);
